...
# Basic sloscribe use case (sloth)

The following guide shows how to use **sloscribe** to generate Sloth SLO specifications, plus prometheus alert groups, for a simple application's metrics.
